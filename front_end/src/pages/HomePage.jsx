...
import { pokedexApi, teamApi } from '../components/utilities';

export default function HomePage() {
	const { isLoggedIn, pokeTeam, setPokeTeam, pokedex, setPokedex, user } =
		useOutletContext();
	...
	return (
		<div className='full_page_div'>
			...
			<div id='home_page_div'>
				...
				<button onClick={handleNewGame} className='home_buttons'>
					New Game
				</button>
				<button onClick={handleContinueGame} className='home_buttons'>
					Continue
				</button>
			</div>
		</div>
