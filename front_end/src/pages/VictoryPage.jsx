			...
			<div className='victory'>
				...
				<div>
					<ListGroup className='victory_team'>
						{pokeTeam.map((pokemon) => (
							<div id='victory_div'>
								<ListGroup.Item variant='secondary' className='victory_list'>
									<img src={pokemon.user_pokemon.pokemon.front_img} />
									{pokemon.user_pokemon.pokemon.name} Lvl{' '}
									{pokemon.user_pokemon.pokemon.lvl}
								</ListGroup.Item>
								<div>
									<ProgressBar
										className='victory_progress'
									...
									<ProgressBar
										...
										id='victory_xp'
										max={100}
										now={pokemon.user_pokemon.pokemon.xp}
										label={`xp: ${pokemon.user_pokemon.pokemon.xp}`}
									/>
								</div>
							</div>
						))}
				...
				<button onClick={handleClick} className='victory_button'>
					Continue
				</button>
				<audio
					autoPlay
					src={victoryPageMusic}
					loop
					type='audio/wav'
					volume='0.2'></audio>
			</div>
